  ...
  switch (action.type) {
    ...
    case `${branch}/${REMOVE_ROW}`:
      return state.withMutations((mutableState) => {
        ...
        const response = axios.get('http://localhost:5000/commoType/delete/'+delete_id)
    ...
    case `${branch}/${SAVE_ROW}`:
      return state.withMutations((mutableState) => {
        ...
        mutableState
          ...
          const response = axios.post('http://localhost:5000/commoType/update/'+update_id, data)
          .then(res => console.log(res.data));
      });
    ...
    case `ADD_DATA`:
      return state.withMutations((mutableState) => {
        ...
        const response = axios.post('http://localhost:5000/commoType/add', action.payload)
          .then(res => console.log(res.data));
      });
